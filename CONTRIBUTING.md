...
Thank you for your interest in contributing to LlamaChat! This document provides guidelines and instructions for contributing to this project.
...
There are many ways to contribute to LlamaChat:
...
3. **Set up the upstream remote**:
   ```bash
   git remote add upstream https://github.com/llamasearchai/llamachat.git
   ```
...
By contributing to LlamaChat, you agree that your contributions will be licensed under the project's MIT License.
